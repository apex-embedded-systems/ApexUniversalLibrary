...
function highlightTOCEntry(framedoc, element)
{
    ...
    if (element != null) {
        ...
        if (element.className == "%TOC_GROUP_CLASSNAME%") {
            newclassname = "%TOC_HIGHLIGHT_GROUP_CLASSNAME%";
        } else if (element.className == "%TOC_TOPIC_CLASSNAME%") {
            newclassname = "%TOC_HIGHLIGHT_TOPIC_CLASSNAME%";
        }
...
{
    var frm = findFrame(top, "%WINDOW_NAME_TOCIDX%");
    var links = null;
    var idx;
...
function synchTOC(topicfile)
{
    ...
    if (frm != null) {
        ...
        if (document.location == frm.document.location) {
            var topicfrm = findFrame(top, "%WINDOW_NAME_TOPIC%");
            if (topicfrm != null) {
...
var collapseStateCookieName = "%COLLAPSE_COOKIE_NAME%"
var collapsePersistenceName = "%COLLAPSE_PERSISTENTSTORE_NAME%"

// If we create browser based HTML files, this variable will be true
var useCookies = %COLLAPSE_STATESAVE_USECOOKIES%;

// If we create HTML Help or Help 2, this variable will be true
var usePersistence = %COLLAPSE_STATESAVE_USEPERSISTENCE%;
