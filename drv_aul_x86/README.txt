...
1. deposit the module into the kernel module repository so to speak.
...
/etc/modules
mod_auldrv offset=0x300,0x310 bytes=0x10,0x10 acronym=stx104,tracere type=stx104,tracere

was: mod_auldrv offset=0x300,0x310 bytes=0x10,0x10 acronym='stx104','tracere' type='stx104','tracere'
Got:  'stx104' and 'tracere' in /dev


was: mod_auldrv offset=0x300,0x310 bytes=0x10,0x10 acronym="stx104","tracere" type="stx104","tracere"
got: I think it was "stx104 and tracere"


WAS: mod_auldrv 
WAS: options mod_auldrv offset=0x300,0x310 bytes=0x10,0x10 acronym="stx104","tracere" type="stx104","tracere"


3. Setup udev and rules

/etc/udev/rules.d/auldrv.rules
SUBSYSTEM=="auldrv" GROUP="users",MODE="0666"
...
mike@Ubuntu32vb:/$ sudo udevadm monitor --environment
[sudo] password for mike: 
monitor will print the received events for:
UDEV - the event which udev sends out after rule processing
KERNEL - the kernel uevent

KERNEL[9471.156645] add      /module/mod_auldrv (module)
ACTION=add
DEVPATH=/module/mod_auldrv
SEQNUM=1530
SUBSYSTEM=module
UDEV_LOG=3

KERNEL[9471.157579] add      /class/auldrv (class)
ACTION=add
...
UDEV  [9471.157638] add      /module/mod_auldrv (module)
ACTION=add
DEVPATH=/module/mod_auldrv
SEQNUM=1530
SUBSYSTEM=module
UDEV_LOG=3
USEC_INITIALIZED=9471157570

UDEV  [9471.158834] add      /class/auldrv (class)
ACTION=add
DEVPATH=/class/auldrv
SEQNUM=1531
SUBSYSTEM=class
UDEV_LOG=3
USEC_INITIALIZED=9471158654

KERNEL[9471.159458] add      /devices/virtual/auldrv/auldrv (auldrv)
ACTION=add
DEVNAME=auldrv
...
UDEV  [9471.161019] add      /devices/virtual/auldrv/auldrv (auldrv)
ACTION=add
DEVNAME=/dev/auldrv
DEVPATH=/devices/virtual/auldrv/auldrv
MAJOR=250
...
SUBSYSTEM=auldrv
UDEV_LOG=3
USEC_INITIALIZED=9471159890

KERNEL[9471.161926] add      /devices/virtual/auldrv/stx104 (auldrv)
ACTION=add
DEVNAME=stx104
...
UDEV  [9471.163251] add      /devices/virtual/auldrv/stx104 (auldrv)
ACTION=add
DEVNAME=/dev/stx104
DEVPATH=/devices/virtual/auldrv/stx104
MAJOR=250
...
SUBSYSTEM=auldrv
UDEV_LOG=3
USEC_INITIALIZED=9471162440

KERNEL[9471.164167] add      /devices/virtual/auldrv/tracere (auldrv)
ACTION=add
DEVNAME=tracere
DEVPATH=/devices/virtual/auldrv/tracere
MAJOR=250
MINOR=2
SEQNUM=1534
SUBSYSTEM=auldrv
...
UDEV  [9471.167080] add      /devices/virtual/auldrv/tracere (auldrv)
ACTION=add
DEVNAME=/dev/tracere
DEVPATH=/devices/virtual/auldrv/tracere
MAJOR=250
