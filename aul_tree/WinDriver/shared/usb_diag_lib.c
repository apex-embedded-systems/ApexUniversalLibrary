...
void PrintDevicePipesInfoByHandle(HANDLE hDevice)
{
    ...
    if (dwError)
    {
        ERR("PrintDevicePipesInfoByHandle: WDU_GetDeviceInfo() failed: error 0x%lx (\"%s\")\n",
...
*/
static WDU_PIPE_INFO *FindPipeInDevice(WDU_DEVICE *pDevice, DWORD dwPipeNumber)
{
    DWORD i;
