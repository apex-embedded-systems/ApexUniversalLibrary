...
/* <EGS_BEGIN>*/
#ifdef COMPONENT_EGS
# define COMPONENT_AVAIL_MODULE_4	{ COMPONENT_EGS,   MODULE_PUBLIC, MODULE_STR(COMPONENT_EGS),   (void *) & component_egs_definition   },
#else
# define COMPONENT_AVAIL_MODULE_4
#endif

/*******************************************************************/

#ifdef COMPONENT_AVAIL_MODULES_V2
#undef COMPONENT_AVAIL_MODULES_V2
#endif
