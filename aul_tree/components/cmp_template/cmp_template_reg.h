...
/*    enum_symbol          row    offset  width  aperture        r/w           acronym	   */ \
	_( <TEMPLATE>_REG_A,		0,		0,		1,		1,		REG_DIR_READ_WRITE,	"a",	0		) \
	_( <TEMPLATE>_REG_B,		1,		1,		1,		1,		REG_DIR_READ_WRITE,	"b",	0		) \
	_( <TEMPLATE>_REG_C,		2,		2,		1,		1,		REG_DIR_READ_WRITE,	"c",	0		) \
	_( <TEMPLATE>_REG_CFG,		3,		3,		1,		1,		REG_DIR_WRITE,		"cfg",	0	)
