...
/* <EGS_BEGIN>*/
#include "../components/egs/cmp_egs_status.h"
/* <EGS_END> */
...
#ifdef COMPONENT_EGS_STATUS
# define COMPONENT_AVAIL_STATUS_CODE_4	COMPONENT_EGS_STATUS_EC_DEFINITIONS( ERROR_CODE_EXTRACTOR )
# define COMPONENT_AVAIL_STATUS_DS_4	COMPONENT_EGS_STATUS_EC_DEFINITIONS( ERROR_DS_EXTRACTOR )
#else
# define COMPONENT_AVAIL_STATUS_CODE_4
# define COMPONENT_AVAIL_STATUS_DS_4
#endif

/*******************************************************************/

#ifdef COMPONENT_AVAIL_STATUS_CODES
#undef COMPONENT_AVAIL_STATUS_CODES
#endif

#ifdef COMPONENT_AVAIL_STATUS_NAMES
#undef COMPONENT_AVAIL_STATUS_NAMES
#endif
...
#define COMPONENT_AVAIL_STATUS_CODES	\
	...
	COMPONENT_AVAIL_STATUS_CODE_2		\
	COMPONENT_AVAIL_STATUS_CODE_3		\
	COMPONENT_AVAIL_STATUS_CODE_4

#define COMPONENT_AVAIL_STATUS_NAMES	\
	COMPONENT_AVAIL_STATUS_DS_1			\
	COMPONENT_AVAIL_STATUS_DS_2			\
	COMPONENT_AVAIL_STATUS_DS_3			\
	COMPONENT_AVAIL_STATUS_DS_4
